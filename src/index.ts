...
export class ContractCallDebuggerCLI {
  private debugger: ContractCallDebugger;
  ...
  private generateSampleTransactions(): Array<{
    hash: string;
    from: string;
    to: string;
    value: bigint;
...
export function createCLI(config?: DebuggerConfig): ContractCallDebuggerCLI {
